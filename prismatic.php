	...
	final class Prismatic {
		...
		public static function instance() {
			...
			if (!isset(self::$instance) && !(self::$instance instanceof Prismatic)) {
				...
				add_action('wp_enqueue_scripts',    'prismatic_enqueue_front');
				add_action('admin_enqueue_scripts', 'prismatic_enqueue_admin');
		...
		private function constants() {
			...
			if (!defined('PRISMATIC_VERSION')) define('PRISMATIC_VERSION', '1.3');
